...
/*
////////////////////////////////////////////////////////////////////////////////////////////
//Programa: TMKC022CX - Grava diariamente o histórico dos totais de ligações do Call Center
//Objetivo: Apurar o índice de cumprimento das ligações tipo "Feedback"
// FILIAL : RAVA CAIXAS - 03
...
dDatahist := Dtos(dData1)
	    ...
	    //MemoWrite("C:\Temp\checkZU8F.sql", cQuery)
	    If Select("ZZU8") > 0
			DbSelectArea("ZZU8")
			DbCloseArea()
		EndIf
