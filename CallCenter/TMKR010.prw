...
User Function TMKR010()		//p/ ser usado pelo setor Pós Vendas
...
if MV_PAR06 = 2     //analítico
	...
	//POR OCORRÊNCIA
	cQry+=" AND RTRIM(UC_CODIGO) >= '" + Alltrim(MV_PAR12) + "' AND RTRIM(UC_CODIGO) <= '" + Alltrim(MV_PAR13) + "' " + LF
	//POR NF
	cQry+=" AND RTRIM(UC_NFISCAL) >= '" + Alltrim(MV_PAR14) + "' AND RTRIM(UC_NFISCAL) <= '" + Alltrim(MV_PAR15) + "' " + LF
