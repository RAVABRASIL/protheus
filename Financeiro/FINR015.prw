...
oReport:SkipLine()
oReport:Say(oReport:Row(),50,"Comissão - 0,2% a partir de 79% ")
oReport:SkipLine()
oReport:Say(oReport:Row(),50,"Comissão - 0,3% a partir de 89% ")
oReport:SkipLine()
oReport:Say(oReport:Row(),50,"Comissão - 0,4% a partir de 100% ")
...
/*
oReport:SkipLine()
oReport:Say(oReport:Row(),20,"POSIÇÃO POR FAIXA DE DIAS")
oSection1:Init()
