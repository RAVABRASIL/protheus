...
oITPARECER := TBUTTON():Create(oDlg1)
...
oDESCLOC:cCaption := "___________________________________"
oDESCLOC:nLeft := 324
oDESCLOC:nTop := 158
oDESCLOC:nWidth := 215
oDESCLOC:nHeight := 17
...
oVLCALC:SetFont( oFNT_2 )
oVLCALC:nCLRTEXT := CLR_BROWN
oVLNEG:SetFont( oFNT_2 )
oVLNEG:nCLRTEXT := CLR_BROWN
oPERC:SetFont( oFNT_2 )
oPERC:nCLRTEXT := CLR_BROWN
oDESCLOC:SetFont( oFNT_2 )
oDESCLOC:nCLRTEXT := CLR_BROWN
