...
oSay19:cName := "oSay19"
oSay19:cCaption := "Responsável p/ parecer:"
oSay19:nLeft := 286
oSay19:nTop := 99
oSay19:nWidth := 125
oSay19:nHeight := 17
...
oITRESP := TGET():Create(oDlg2)
oITRESP:cName := "oITRESP"
oITRESP:nLeft := 413
oITRESP:nTop := 95
oITRESP:nWidth := 271
oITRESP:nHeight := 21
...
oITRESP:lReadOnly := .F.
oITRESP:Align := 0
oITRESP:cVariable := "cITRESP"
oITRESP:bSetGet := {|u| If(PCount()>0,cITRESP:=u,cITRESP) }
oITRESP:lVisibleControl := .T.
oITRESP:lPassword := .F.
oITRESP:lHasButton := .F.
...
// AQUI
oSay29 := TSAY():Create(oDlg2)
oSay29:cName := "oSay29"
oSay29:cCaption := "Observacao:"
oSay29:nLeft := 15
oSay29:nTop := 321
oSay29:nWidth := 65
oSay29:nHeight := 17
...
oPAR1:lReadOnly := .F.
oPAR1:Align := 0
oPAR1:cVariable := "cPAR1"
oPAR1:bSetGet := {|u| If(PCount()>0,cPAR1:=u,cPAR1) }
oPAR1:lVisibleControl := .T.
oPAR1:lPassword := .F.
oPAR1:lHasButton := .F.

oPAR2 := TGET():Create(oDlg2)
oPAR2:cName := "oPAR2"
oPAR2:nLeft := 13
oPAR2:nTop := 371
oPAR2:nWidth := 678
...
oPAR2:lReadOnly := .F.
oPAR2:Align := 0
oPAR2:cVariable := "cPAR2"
oPAR2:bSetGet := {|u| If(PCount()>0,cPAR2:=u,cPAR2) }
oPAR2:lVisibleControl := .T.
oPAR2:lPassword := .F.
oPAR2:lHasButton := .F.

oPAR3 := TGET():Create(oDlg2)
oPAR3:cName := "oPAR3"
oPAR3:nLeft := 13
oPAR3:nTop := 396
oPAR3:nWidth := 678
...
oPAR3:lReadOnly := .F.
oPAR3:Align := 0
oPAR3:cVariable := "cPAR3"
oPAR3:bSetGet := {|u| If(PCount()>0,cPAR3:=u,cPAR3) }
oPAR3:lVisibleControl := .T.
oPAR3:lPassword := .F.
oPAR3:lHasButton := .F.

oPAR4 := TGET():Create(oDlg2)
oPAR4:cName := "oPAR4"
oPAR4:nLeft := 13
oPAR4:nTop := 421
oPAR4:nWidth := 678
...
oPAR4:lReadOnly := .F.
oPAR4:Align := 0
oPAR4:cVariable := "cPAR4"
oPAR4:bSetGet := {|u| If(PCount()>0,cPAR4:=u,cPAR4) }
oPAR4:lVisibleControl := .T.
oPAR4:lPassword := .F.
oPAR4:lHasButton := .F.

oPAR5 := TGET():Create(oDlg2)
oPAR5:cName := "oPAR5"
oPAR5:nLeft := 13
oPAR5:nTop := 446
oPAR5:nWidth := 678
...
oPAR5:lReadOnly := .F.
oPAR5:Align := 0
oPAR5:cVariable := "cPAR5"
oPAR5:bSetGet := {|u| If(PCount()>0,cPAR5:=u,cPAR5) }
oPAR5:lVisibleControl := .T.
oPAR5:lPassword := .F.
oPAR5:lHasButton := .F.

oGRP2:SetColor( CLR_HRED )
oGRP27:SetColor( CLR_CYAN )

oDESCPDT:SetFont( oFNT_2 )
oDESCPDT:nCLRTEXT := CLR_BROWN
oQUANTP:SetFont( oFNT_2 )
oQUANTP:nCLRTEXT := CLR_BROWN
oVLPEDIT:SetFont( oFNT_2 )
oVLPEDIT:nCLRTEXT := CLR_BROWN
oVLCALCIT:SetFont( oFNT_2 )
oVLCALCIT:nCLRTEXT := CLR_BROWN
