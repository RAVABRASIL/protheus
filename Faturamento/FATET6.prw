...
ฑฑบPrograma  ณNOVO2     บ Autor ณ AP6 IDE            บ Data ณ  21/10/08   บฑฑ
...
Local cDesc3         := "Preco Rava - Etapa 6"
Local cPict          := ""
Local titulo       	 := "Preco Rava - Etapa 6"
Local nLin         	 := 80
                       //012345678901234567890123456789012345678901234567890123456789
                       //          10        20        30        40        50
                       //XXXXXXXXXXXXXXX  999,999,999.99
Local Cabec1         := "     Produto         Preco Rava"
Local Cabec2         := ""
Local imprime        := .T.
Local aOrd           := {}
Private lEnd         := .F.
...
Private limite       := 80
Private tamanho      := "P"
Private nomeprog     := "FATET6" // Coloque aqui o nome do programa para impressao no cabecalho
Private nTipo        := 18
...
Private CONTFL       := 01
Private m_pag        := 01
Private wnrel        := "FATET6" // Coloque aqui o nome do arquivo usado para impressao em disco
Private cString      := ""
Pergunte("FATET1",.T.)
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบFuno    ณRUNREPORT บ Autor ณ AP6 IDE            บ Data ณ  21/10/08   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
//"     Produto         Preco Rava"
   ...
   @nLin,00 PSAY _TMPZ->Z30_PRODUT
   @nLin,17 PSAY transform( mv_par01 * (posicione("SB1",1,xFilial("SB1")+_TMPZ->Z30_PRODUT, "B1_PESO")/posicione("SB5",1,xFilial("SB5")+_TMPZ->Z30_PRODUT, "B5_QE2")*1000 )*;
