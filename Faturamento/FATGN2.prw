...
@ C(243), C(285) TO C(440),C(520) Dialog _oDlg Title "Informacoes Extras"
  ...
  @ C(058),C(003) Say    "Observações:"  Size 040,007
  @ C(072),C(030) BmpButton type 1 action ChecaEdits(dEdit1, dEdit2, cEdit3, dEdit5) //atenção, cEdit5 é oq contém a data alterada
...
if nCol == 1 .OR. nCol == 8 .OR. nCol == 10
	for nX := 1 to Len(oBrowse:aColumns)
	   if nX == 1 .OR. nX == 8 .OR. nX == 10
