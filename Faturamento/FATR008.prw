...
/*******************************************************************/
*********************************************
User Function FATR008( cAlias, nReg ) 
*********************************************
...
wnrel:=SetPrint(cString,wnrel,If(lAuto,Nil,"NFSIGW"),@Titulo,cDesc1,cDesc2,cDesc3,.F.,,,Tamanho,,!lAuto)  
...
If mv_par04 == 2
   ...
   While !Eof() .and. SF2->F2_DOC >= mv_par01 .And. SF2->F2_DOC <= mv_par02 ;
      ...
      while !SE1->(eof()) .and. SE1->E1_NUM==xNUM_DUPLIC .and. xDUPLICATAS==.T.
         ...
         */ //Comentei, pois noa imprimimos mais o boleto direto na Rava - Eurivan  - 27/08/10
         SE1->(dbSkip())
      EndDo
