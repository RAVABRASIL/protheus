...
/*******************************************************************/
//Esta função imprime o espelho da nota fiscal em formato HTML
//É chamada dentro do programa DTEXPED, retorna o diretório de gravação
//do arquivo para fins de anexa-lo ao e-mail que vai para o cliente.
//Não colocar para chamar dentro do menu, pois não é adequado.
//Autoria: Flávia Rocha
//Data: 21/12/2009 
/*******************************************************************/

*********************************************
User Function FATR009( cAlias, nReg ) 
*********************************************
...
SetPrvt("CCOR,NTAMDET,XB_ICMS_SOL,XV_ICMS_SOL,LFLAG,NCONT, cWeb")
...
//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
   ...
   //cRetorna := PrtDetail(@lEnd,wnRel,cString,nReg)
   cRetorna := PrtDetail( cAlias, nReg, lAuto )
   Return( cRetorna )

***************************************************
Static Function PrtDetail( cAlias, nReg, lAuto )
***************************************************
   ...
   While !Eof() .and. SF2->F2_DOC >= mv_par01 .And. SF2->F2_DOC <= mv_par02 ;
      ...
      For I:=1 to Len(xPED_VEND)
          ...
          If ASCAN(xPED,xPED_VEND[I])==0
             ...
             xCOD_VEND:= SC5->C5_VEND1              // Codigo do Vendedor 5
      ...
      dbSetOrder(1)
      If !Empty(xCONDPAG)
      	SE4->(dbSeek(xFilial("SE4")+xCONDPAG))
      ...
      //J:=Len(xCOD_VEND)
      //For I:=1 to 5 //J
          //SA3->(dbSeek(xFilial("SA3")+ xCOD_VEND[I]))
          SA3->(dbSeek(xFilial("SA3")+ xCOD_VEND ))
...
*/
      ...
      Endif
        ...
        cWeb:=""
        cWeb+='<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">'
        cWeb+='<html xmlns="http://www.w3.org/1999/xhtml">'
        cWeb+='<head>'
        cWeb+='<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />'
        cWeb+='<title>ESPELHO DE NOTA FISCAL</title>'
        cWeb+='<style type="text/css">'
        cWeb+='<!--'
        cWeb+='.style1 {'
        cWeb+='	font-family: Verdana, Arial, Helvetica, sans-serif;'
        cWeb+='	font-weight: bold;'
        cWeb+='	font-size: 20px;'
        cWeb+='}'
        cWeb+='.style3 {'
        cWeb+='	font-family: Verdana, Arial, Helvetica, sans-serif;'
        ...
        cWeb+='	font-weight: bold;'
        cWeb+='}'
        cWeb+='.style5 {font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px; font-weight: bold; }'
        cWeb+='.style6 {font-family: Verdana, Arial, Helvetica, sans-serif}'
        cWeb+='.style7 {font-size: 10px}'
        cWeb+='.style9 {font-family: Verdana, Arial, Helvetica, sans-serif; font-weight: bold; }'
        cWeb+='.style12 {font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 10px; font-weight: bold; }'
        cWeb+='.style13 {font-size: 12px; font-family: Verdana, Arial, Helvetica, sans-serif;}'
        cWeb+='.style14 {font-size: 11px}'
        cWeb+='-->'
        cWeb+='</style>'
        cWeb+='</head>'
        cWeb+=''
        cWeb+='<body>'
        cWeb+='<table width="918" border="1">'
        cWeb+='  <tr>'
        cWeb+='    <td width="300" rowspan="2"><div align="center" class="style1">'+ ALLTRIM(SM0->M0_NOMECOM) +'</div></td>'
        cWeb+='    <td width="406"><div align="center"><span class="style3">'+alltrim( SM0->M0_ENDCOB )+' - CEP: '+substr(SM0->M0_CEPCOB,1,5)+'-'+substr(SM0->M0_CEPCOB,6,3)+'<br/>'+alltrim( SM0->M0_BAIRCOB )+'</span></div></td>'
        cWeb+='    <td width="190" rowspan="2"><p align="center" class="style5">ESPELHO DE NOTA<BR /> FISCAL </p></td>'
        cWeb+='  </tr>'
        cWeb+='  <tr>'
        cWeb+='    <td height="18"><div align="center"><span class="style4">MUNIC&Iacute;PIO DE '+alltrim( SM0->M0_CIDCOB )+' - ESTADO DE '+alltrim( SM0->M0_ESTCOB )+'</span></div></td>'
        cWeb+='  </tr>'
        cWeb+='  <tr>'
        cWeb+='    <td height="22"><div align="center"><span class="style3">FONE: '+alltrim( SM0->M0_TEL )+' - FAX: '+alltrim( SM0->M0_FAX )+'</span></div></td>'
        cWeb+='    <td><div align="center" class="style6">'
        cWeb+='      <p class="style14">C.N.P.J. '+Transform(SM0->M0_CGC,"@R 99.999.999/9999-99")+' I.E. '+Transform(SM0->M0_INSC,"@R 999.999.999.999")+' <br />'
...
//        Next
      ...
      nRet := ShellExecute("open",cDirHTM+cArqHTM, "", "", 1)
...
If aReturn[5] == 1
   Set Printer TO
   dbcommitAll()   
   Return( cDirHTM + cArqHTM )   
   //ourspool(wnrel)	//FR: esta chamada é que define se vai aparecer na tela / imprimir na impressora.
Endif
...
nTamDet :=99            // Tamanho da Area de Detalhe
...
cWeb+='<table width="918" border="1">'
cWeb+='  <tr>'
cWeb+='    <td width="75" rowspan="2"><div align="center" class="style6"><span class="style7">CODIGO</span></div>      <span class="style6"></span></td>'
cWeb+='    <td width="35" rowspan="2"><div align="center" class="style6"><span class="style7">QUANT.</span></div>      <span class="style6"></span></td>'
cWeb+='    <td width="586" rowspan="2"><div align="center"><span class="style3">D I S C R I M I N A &Ccedil; &Atilde; O</span></div></td>'
cWeb+='    <td colspan="2"><div align="center"><span class="style3">PRE&Ccedil;O</span></div></td>'
cWeb+='    <td colspan="2"><div align="center"><span class="style3">ALIQUOTAS</span></div></td>'
cWeb+='  </tr>'
cWeb+='  <tr>'
cWeb+='    <td width="112"><span class="style3">UNIT&Aacute;RIO</span></td>'
cWeb+='    <td width="127"><span class="style3">TOTAL</span></td>'
cWeb+='    <td width="112"><span class="style3">IPI %</span></td>'
cWeb+='    <td width="112"><span class="style3">ICM %</span></td>'
cWeb+='  </tr>'
...
For I:=1 to nTamDet
    ...
    If I<= Len(xCOD_PRO)
       ...
       @ nLin, 136  PSAY xVAL_IPI[I]               Picture "@E 9,999.99"
       	...
       	cWeb+='  <tr>'
       	cWeb+='  <td><span class="style12">'+transform(xCOD_PRO[I],"@!")+'&nbsp;</span></td>'
        cWeb+='  <td><span class="style12">'+transform(xQTD_PRO[I],"@E 999,999")+'&nbsp;</span></td>'
        cWeb+='  <td><span class="style12">'+Substr(xDESCRICAO[I],1,78)+'<br/>'+Substr(xDESCRICAO[I],81,151)+'&nbsp;'
     	IF (Substr(xDESCRICAO[I],161,200)) <> ""
		   cWeb+='<br/>'+Substr(xDESCRICAO[I],151,200)
		ENDIF
		cWeb+='</span></td>'
        cWeb+='  <td><span class="style12">'+transform(xPRE_UNI[I] ,"@E 99,999,999.99")+'&nbsp;</span></td>'
        cWeb+='  <td><span class="style12">'+transform(xVAL_MERC[I],"@E 99,999,999.99")+'&nbsp;</span></td>'
        cWeb+='  <td><span class="style12">'+transform(xIPI[I]     ,"@E 99.99")+'&nbsp;</span></td>'
        cWeb+='  <td><span class="style12">'+transform(xICM_PROD[I],"@E 99.99")+'&nbsp;</span></td>'
        cWeb+='</tr>'
...
Next    
    nLin :=nLin+1
		cWeb+='  <tr>'       
       	cWeb+='  <td><span class="style12">&nbsp;</span></td>'
        cWeb+='  <td><span class="style12">&nbsp;</span></td>'
        cWeb+='  <td><span class="style12">&nbsp;</span></td>'
        cWeb+='  <td><span class="style12">TOTAL MERC.</span></td>'
        cWeb+='  <td><span class="style12">'+transform(xVALOR_MERC,"@E 99,999,999.99")+'&nbsp;</span></td>'
        cWeb+='</tr>'
		cWeb+='  </table>'
...
If !Empty(xCOD_MENS)
   ...
   @ nLin, NCol PSAY FORMULA(xCOD_MENS)
   	...
   	cWeb+=' <tr>'
	cWeb+=' <td><span class="style12">&nbsp;</span></td>'
    cWeb+=' <td width="910" class="style3">'+FORMULA(xCOD_MENS)+'</td>'
	cWeb+=' <td><span class="style12">&nbsp;</span></td>'
	cWeb+=' <td><span class="style12">&nbsp;</span></td>'
	cWeb+=' </tr>'
	cWeb+=' </table> '	
...
cWeb+=' <tr>'
//cWeb+=' <td><span class="style12">&nbsp;</span></td>'
cWeb+='    <td width="910" class="style3">OBS:'+UPPER(SUBSTR(xMENSAGEM,1,nTamObs))+'<br/>'+UPPER(SUBSTR(xMENSAGE1,151,nTamObs))+'<br/>'+UPPER(SUBSTR(xMENSAGE2,301,nTamObs))+'</td>'
//cWeb+=' <td><span class="style12">&nbsp;</span></td>'
//cWeb+=' <td><span class="style12">&nbsp;</span></td>'
cWeb+=' </tr>'
cWeb+='</table>'
...
cWeb+='	<table width="918" border="1">'
cWeb+='  <tr>'
cWeb+='    <td width="211" rowspan="2"><div align="center" class="style3">NF N&#176</div></td>'
cWeb+='    <td width="180" colspan="2"><div align="center"><span class="style3">DUPLICATA</span></div></td>'
//cWeb+='    <td width="151"><div align="center"><span class="style3">DUPLICATA</span></div></td>'
cWeb+='    <td width="157" rowspan="2"><div align="center"><span class="style3">VENCIMENTO</span></div></td>'
//cWeb+='    <td width="185"><div align="center" class="style7"><span class="style3">PARA USO DA INSTITUI&Ccedil;&Atilde;O FINANCEIRA</span></div></td>'
cWeb+='  </tr>'
cWeb+='  <tr>'
cWeb+='    <td><div align="center"><span class="style3">VALOR R$</span></div></td>'
cWeb+='    <td><div align="center"><span class="style3">NUMERO</span></div></td>'
//cWeb+='    <td><div align="center"><span class="style3">VALOR R$</span></div></td>'
//cWeb+='    <td rowspan="3">&nbsp;</td>'
cWeb+='  </tr>'
...
For BB:= 1 to Len(xVALOR_DUP)
   If xDUPLICATAS==.T. .and. BB <= Len(xVALOR_DUP)
   		...
   		cWeb+='  <tr>'
       	cWeb+='    <td><span class="style12">'+xNUM_DUPLIC+'</span></td>'
       	cWeb+='    <td><span class="style12">'+transform(xVALOR_DUP[BB],"@E 9,999,999.99")+'</span></td>'
       	cWeb+='    <td><span class="style12">'+xNUM_DUPLIC + xPARC_DUP[BB]+'</span></td>'  
        cWeb+='    <td><span class="style12">'+dtoc(xVENC_DUP[BB])+'</span></td>'
       	cWeb+='  </tr>'
...
if xDuplicatas == .F. //.and. cE4Tipo == "9"
    cWeb+='  <tr>'
    cWeb+='    <td><span class="style12">'+xNUM_NF+'</span></td>'
    cWeb+='    <td><span class="style12">'+transform(xTOT_FAT,"@E 9,999,999.99")+'</span></td>'
    cWeb+='    <td><span class="style12">'+xNUM_NF+'</span></td>'
    cWeb+='    <td><span class="style12">...'+ALLTRIM(xDESC_PAG)+'...</span></td>'	    	
    cWeb+='  </tr>'
endif 

cWeb+='	  <tr>'
cWeb+='    <td colspan="2"><span class="style3">DESCONTO DE: </span></td>'
cWeb+='    <td colspan="2"><span class="style3">P/ PAGAMENTO AT&Eacute;:</span></td>'
cWeb+='  </tr>'
cWeb+='</table>'

/*
cWeb+='<br />'
cWeb+='<table width="920" border="1">'
cWeb+='  <tr>'
cWeb+='    <td width="910" height="17"><p align="center" class="style6 style3">NA FALTA DE PAGAMENTO NO VENCIMENTO SER&Atilde;O COBRADOS JUROS E TAXA DE PERMAN&Ecirc;NCIA</p>    </td>'
cWeb+='  </tr>'
cWeb+='</table>'
*/
Return
...
Static Function extens()

nValor := xTOT_FAT // SF2->F2_VALFAT

// Gera o extenso do valor, formatando a variável com 200 caracteres preenchendo os espaços em branco com *
cExtenso := PADR(Extenso(nValor),220,"*")
// Imprime o extenso em duas linhas (110 caracteres em
// cada):              

cWeb+='<br />'
cWeb+='<table width="918" border="1">'
cWeb+='  <tr>'
cWeb+='    <td width="118"><p align="center" class="style13">TOTAL <br />'
cWeb+='      POR <br />'
cWeb+='    EXTENSO</p></td>'
cWeb+='    <td width="784" class="style12">'+Substr(cExtenso,1,110)+'<br/>'+Substr(cExtenso,111,110)
cWeb+='</td>'
cWeb+='  </tr>'
cWeb+='</table>'
//cWeb+='<br />'
...
cWeb+='<table width="920" border="1">'
cWeb+='  <tr>'
cWeb+='    <td width="910"><p class="style3">DEVEM A <strong>'+ALLTRIM(SM0->M0_NOMECOM)+'</strong>, A IMPORT&Acirc;NCIA CORRESPONDENTE &Agrave; VEICULA&Ccedil;&Atilde;O DE PUBLICIDADE.<br/>'
cWeb+='    (IMUNIDADE TRIBUT&Aacute;RIA - ART. 150 (D) DA CONSTITUI&Ccedil;&Atilde;O FEDERAL)</p></td>'
cWeb+='  </tr>'
cWeb+='</table>'
*/
...
Local nMes  := Month(xEmissao)


cWeb += '      EMISS&Atilde;O: <span class="style9">' + STRZero( DAY(xEmissao),2 ) + " de " + MesExtenso( nMes ) + ", "+ alltrim(str(year(xEmissao)))+'</span></p>'
cWeb += '    </div></td>'
cWeb += '    <td><p class="style9">      N&#176 '+xNUM_NF+'</p>'
cWeb += '    </td>'
cWeb += '</table>'
cWeb += '<br/>    '
...
cWeb+='<table width="918" border="1">'
cWeb+='  <tr>'
cWeb+='    <td width="124"><span class="style3">CLIENTE:</span></td>'
cWeb+='    <td colspan="4"><span class="style3"><strong>'+ alltrim(xNOME_CLI) + '</strong></span></td>'
cWeb+='  </tr>'
cWeb+='  <tr>'
cWeb+='    <td><span class="style3">ENDERE&Ccedil;O:</span></td>'
cWeb+='    <td colspan="4"><span class="style3"><strong>'+alltrim(xEND_CLI)
if !empty(xBAIRRO)
   cWeb+=' - '+alltrim(xBAIRRO)
Endif
cWeb+='</strong></span></td>'
cWeb+='  </tr>'
cWeb+='  <tr>'
cWeb+='    <td><div align="left"><span class="style3">MUN&Iacute;CIPIO:</span></div></td>'
cWeb+='    <td><div align="left"><span class="style3"><strong>'+alltrim(xMUN_CLI)+'</strong></span></div></td>'
cWeb+='    <td colspan="2"><div align="left"><span class="style3">ESTADO:</span><span class="style12">'+xEST_CLI+'</span></div>      <div align="left"></div></td>'
cWeb+='    <td width="166"><div align="left"><span class="style3">CEP:</span><span class="style12">'+transform(xCEP_CLI,"@R 99999-999")+'</span></div></td>'
cWeb+='  </tr>'
cWeb+='  <tr>'
cWeb+='    <td><span class="style3">PRA&Ccedil;A DE PAGTO:</span></td>'

iif (SM0->M0_CODIGO == "02",nLin:=21,nLin:=19)
if ALLTRIM(xCOB_CLI) <> ""
   cWeb+='    <td colspan="4"><span class="style3"><strong>'+xCOB_CLI+'</strong></span></td>'	
else
   cWeb+='    <td colspan="4"><span class="style3"><strong>O MESMO</strong></span></td>'	
endif
cWeb+='  </tr>'
cWeb+='  <tr>'
cWeb+='    <td><span class="style3">I. C.N.P.J. N&#176</span></td>'

iif (SM0->M0_CODIGO == "02",nLin:=22,nLin:=20)
If !EMPTY(xCGC_CLI)                   // Se o C.G.C. do Cli/Forn nao for Vazio
	if SA1->A1_PESSOA = "J"
        cWeb+='    <td width="373"><span class="style3"><strong>'+transform(xCGC_CLI,"@R 99.999.999/9999-99")+'&nbsp;</strong></span></td>'
	else
        cWeb+='    <td width="373"><span class="style3"><strong>'+transform(xCGC_CLI,"@R 999.999.999-99")+'&nbsp;</strong></span></td>'
	endif
Else
        cWeb+='    <td width="373"><span class="style3"><strong>&nbsp;</strong></span></td>'
Endif


cWeb+='    <td width="153"><span class="style3">INSCRI&Ccedil;&Atilde;O ESTADUAL:</span></td>'
cWeb+='    <td colspan="2"><span class="style12">'+xINSC_CLI+'&nbsp;</span></td>'
cWeb+='  </tr>'
cWeb+='</table>'
...
cWeb+='	<table width="918" border="1">'
cWeb+='  <tr>'
cWeb+='    <td width="211" ><div align="center" class="style3">BASE ICMS</div></td>'
cWeb+='    <td width="180"><div align="center"><span class="style3">VALOR ICMS</span></div></td>'
cWeb+='    <td width="151"><div align="center"><span class="style3">BASE IPI</span></div></td>'
cWeb+='    <td width="157"><div align="center"><span class="style3">VALOR IPI</span></div></td>'
//cWeb+='    <td width="185"><div align="center" class="style7"><span class="style3">PARA USO DA INSTITUI&Ccedil;&Atilde;O FINANCEIRA</span></div></td>'
cWeb+='  </tr>'
//cWeb+='  <tr>'
//cWeb+='    <td><div align="center"><span class="style3">VALOR R$</span></div></td>'
//cWeb+='    <td><div align="center"><span class="style3">N&#176 DE ORDEM</span></div></td>'
//cWeb+='    <td rowspan="3">&nbsp;</td>'
//cWeb+='  </tr>'

cWeb+='  <tr>'
cWeb+='  <td><span class="style12">' + transform( XBASE_ICMS,"@E 999,999.99")+'&nbsp;</span></td>'
cWeb+='  <td><span class="style12">'+transform( XVALOR_ICMS ,"@E 999,999.99")+'&nbsp;</span></td>'
cWeb+='  <td><span class="style12">'+transform( XBASE_IPI   ,"@E 999,999.99")+'&nbsp;</span></td>'
cWeb+='  <td><span class="style12">'+transform( XVALOR_IPI   ,"@E 999,999.99")+'&nbsp;</span></td>'
cWeb+=' </tr>'	
cWeb+='</table>'
...
//  If Len(xVendedor) > 0 .and. Len(xCod_vend) > 0
    If Len(xVendedor) > 0 .and. ! empty(xCod_vend) 
   	//@ 50, 048 pSay xVendedor[ 1 ] + " " + xCod_vend[ 1 ]
      @ 50, 048 pSay xVendedor[ 1 ] + " " + xCod_vend  
  Endif
Endif
