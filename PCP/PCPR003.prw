...
ฑฑบPrograma  ณNOVO8     บ Autor ณ AP6 IDE            บ Data ณ  29/05/09   บฑฑ
...
Local cDesc3         := ""
Local cPict          := ""
Local titulo         := "EXTRUSOR-Acompanhamento Grama metro "
Local nLin           := 80
...
Private limite       := 80
Private tamanho      := "P"
Private nomeprog     := "PCPR003" // Coloque aqui o nome do programa para impressao no cabecalho
Private nTipo        := 18
...
Private CONTFL       := 01
Private m_pag        := 01
Private wnrel        := "PCPR003" // Coloque aqui o nome do arquivo usado para impressao em disco
...
wnrel := SetPrint(cString,NomeProg,"PCPR003",@titulo,cDesc1,cDesc2,cDesc3,.T.,aOrd,.T.,Tamanho,,.T.)
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบFuno    ณRUNREPORT บ Autor ณ AP6 IDE            บ Data ณ  29/05/09   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
cQry:="SELECT Z44_EXTRUS,Z44_MESANO,Z44_MAQ, "
...
cQry+="AND Z44_EXTRUS BETWEEN '"+MV_PAR03+"' AND '"+MV_PAR04+"' "
cQry+="AND Z44.D_E_L_E_T_!='*' "
cQry+="GROUP BY Z44_EXTRUS,Z44_MESANO,Z44_MAQ "
cQry+="ORDER BY Z44_EXTRUS,Z44_MESANO,Z44_MAQ " 
...
While TMPZ->( !EOF() )
   ...
   @nLin++,00 PSAY "Nome: "+Posicione('SRA',1,xFilial("SRA")+TMPZ->Z44_EXTRUS,"RA_NOME")
   @nLin++
   @nLin++,00 PSAY  "                   Menor Variacao           Maior Variacao   "
   @nLin++,00 PSAY "Periodo  Maq      Gr/m       Largura      Gr/m      Largura"
   @nLin++
   cMat:=TMPZ->Z44_EXTRUS
   Do While TMPZ->( !EOF() ) .AND. cMat=TMPZ->Z44_EXTRUS
     ...
     @nLin++,00 PSAY  TRANSFORM(TMPZ->Z44_MESANO,"@R ##/####")+SPACE(2)+TMPZ->Z44_MAQ+;
                      ...
                      TRANSFORM(TMPZ->MAXLARG,"@E 999,999.99" )
