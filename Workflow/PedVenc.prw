...
If Select( 'SX2' ) == 0
    ...
    PREPARE ENVIRONMENT EMPRESA "02" FILIAL "01" FUNNAME "PEDVENC" Tables "SA3", "SF2", "SA1"
...
cQuery := "SELECT distinct SC5.C5_NUM AS PEDIDO, SC5.C5_ENTREG AS DTFATUR, SC5.C5_EMISSAO AS EMISS, A1_COD+' - '+A1_NOME AS CLIENTE  "+ CHR(13) + CHR(10)
cQuery += "FROM  SA1010 SA1, SB1010 SB1, SC5020 SC5, SC6020 SC6, SC9020 SC9 "+ CHR(13) + CHR(10)
cQuery += "WHERE ( SC6.C6_QTDVEN - SC6.C6_QTDENT ) > 0 AND SC6.C6_BLQ <> 'R' AND SB1.B1_TIPO = 'PA' AND "+ CHR(13) + CHR(10)
cQuery += "SC5.C5_CLIENTE = SA1.A1_COD AND SC6.C6_PRODUTO = SB1.B1_COD AND SC5.C5_NUM = SC6.C6_NUM AND  "+ CHR(13) + CHR(10)
cQuery += "SC9.C9_PEDIDO + SC9.C9_ITEM = SC6.C6_NUM + SC6.C6_ITEM and SC9.C9_PEDIDO = SC5.C5_NUM AND "+ CHR(13) + CHR(10)
//cQuery += "SC9.C9_BLCRED = '  ' and SC9.C9_BLEST != '10' AND "
// NOVA LIBERACAO DE CREDITO
cQuery += "SC9.C9_BLCRED IN( '  ','04') and SC9.C9_BLEST != '10' AND "+ CHR(13) + CHR(10)
cQuery += "SB1.D_E_L_E_T_ = ' ' AND SC5.D_E_L_E_T_ = ' ' AND SC6.D_E_L_E_T_ = ' ' AND SC9.D_E_L_E_T_ = ' ' "+ CHR(13) + CHR(10)
cQuery += "order by SC5.C5_ENTREG "+ CHR(13) + CHR(10)
...
*/
MemoWrite("C:\TEMP\PEDVENC.SQL", cQuery )
...
if lOk
    ...
    oProcess:cTo := "renato.maia@ravaembalagens.com.br"
