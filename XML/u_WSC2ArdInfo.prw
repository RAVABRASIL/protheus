...
Gerado em        04/01/14 14:18:57
Observações      Código-Fonte gerado por ADVPL WSDL Client 1.120703
                 Alterações neste arquivo podem causar funcionamento incorreto
                 e serão perdidas caso o código-fonte seja gerado novamente.
=============================================================================== */

User Function _DSVOMQJ ; Return  // "dummy" function - Internal Use 
...
cSoap += '<RETORNAURL xmlns="http://10.0.0.16/ws/u_wsardinfo.apw">'
cSoap += "</RETORNAURL>"

oXmlRet := SvcSoapCall(	Self,cSoap,; 
	"http://10.0.0.16/ws/u_wsardinfo.apw/RETORNAURL",; 
	"DOCUMENT","http://10.0.0.16/ws/u_wsardinfo.apw",,"1.031217",; 
	"http://10.0.0.16:8081/ws/U_WSARDINFO.apw")
