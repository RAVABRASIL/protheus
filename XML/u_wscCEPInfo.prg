...
cSoap += '<CEPSEARCH xmlns="http://10.0.0.10:8088/ws/u_wscepinfo.apw">'
cSoap += WSSoapValue("CEP", ::cCEP, cCEP , "string", .T. , .F., 0 , NIL, .F.) 
cSoap += "</CEPSEARCH>"

oXmlRet := SvcSoapCall(	Self,cSoap,; 
	"http://10.0.0.10:8088/ws/u_wscepinfo.apw/CEPSEARCH",; 
	"DOCUMENT","http://10.0.0.10:8088/ws/u_wscepinfo.apw",,"1.031217",; 
	"http://10.0.0.10:8088/ws/U_WSCEPINFO.apw")
