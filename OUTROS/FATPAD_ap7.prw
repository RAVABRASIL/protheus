...
User Function FATPAD1()        // incluido pelo assistente de conversao do AP5 IDE em 19/08/02
...
SetPrvt("CPERG,MV_PAR01,MV_PAR02,DDATA,DDATAAUX,NDIAMAX")
SetPrvt("CINDEXSD2,DINDEXSD2,NINDEXSD2,ACAMPOS,AQ,AV")
SetPrvt("APQ,APV,GRUPANT,CLIANT,FATVAL01,FATQTD01")
SetPrvt("FATVALHJ,FATQTDHJ,N,CINDEXSC6,NINDEXSC6,GRUPO")
SetPrvt("PEDVAL01,PEDQTD01,PEDVALHJ,PEDQTDHJ,VALOR,DIA")
SetPrvt("I,J,_SALIAS,AREGS,")
...
±±³Descri‡…o ³ Cria o DBF de Faturamento e Pedido Padrao                  ³±±
...
// Substituido pelo assistente de conversao do AP5 IDE em 19/08/02 ==> Function ValidPerg
