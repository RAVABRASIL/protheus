...
************
Static Function Procura(cCBarra)
************
	...
	If !('ME' $ cProduto)
		While cBarra != aConsulta[nContador, 2] //.and. nContador <= 67
			nContador := nContador + 1
		Enddo

		SB1->( DBSETORDER( 1 ) )
		SB1->( Dbseek( xFilial( "SB1" ) + aConsulta[nContador, 1] ) )
		cDescProd := Alltrim(SB1->B1_DESC)
		cProduto := Alltrim(aConsulta[nContador, 1])
		SB1->( DbCloseArea() )
		oSayProduto2:cCaption := cProduto
		oSayDesc:cCaption := cDescProd
		//nContador := AScan( aConsulta, cBarra )//, 1, Len(aConsulta) )

		If nContador == 1
			oSayLin1:nClrText := CLR_HRED
		ElseIf nContador == 2
			oSayLin2:nClrText := CLR_HRED
		ElseIf nContador == 3
			oSayLin3:nClrText := CLR_HRED
		ElseIf nContador == 4
			oSayLin4:nClrText := CLR_HRED
		ElseIf nContador == 5
			oSayLin5:nClrText := CLR_HRED
		ElseIf nContador == 6
			oSayLin6:nClrText := CLR_HRED
		ElseIf nContador == 7
			oSayLin7:nClrText := CLR_HRED
		ElseIf nContador == 8
			oSayLin8:nClrText := CLR_HRED
		ElseIf nContador == 9
			oSayLin9:nClrText := CLR_HRED
		ElseIf nContador == 10
			oSayLin10:nClrText := CLR_HRED
		ElseIf nContador == 11
			oSayLin11:nClrText := CLR_HRED
		ElseIf nContador == 12
			oSayLin12:nClrText := CLR_HRED
		ElseIf nContador == 13
			oSayLin13:nClrText := CLR_HRED
		ElseIf nContador == 14
			oSayLin14:nClrText := CLR_HRED
		ElseIf nContador == 15
			oSayLin15:nClrText := CLR_HRED
		ElseIf nContador == 16
			oSayLin16:nClrText := CLR_HRED
		ElseIf nContador == 17
			oSayLin17:nClrText := CLR_HRED
		ElseIf nContador == 18
			oSayLin18:nClrText := CLR_HRED
		ElseIf nContador == 19
			oSayLin19:nClrText := CLR_HRED
		ElseIf nContador == 20
			oSayLin20:nClrText := CLR_HRED
		ElseIf nContador == 21
			oSayLin21:nClrText := CLR_HRED
		ElseIf nContador == 22
			oSayLin22:nClrText := CLR_HRED
		ElseIf nContador == 23
			oSayLin23:nClrText := CLR_HRED
		ElseIf nContador == 24
			oSayLin24:nClrText := CLR_HRED
		ElseIf nContador == 25
			oSayLin25:nClrText := CLR_HRED
		ElseIf nContador == 26
			oSayLin26:nClrText := CLR_HRED
		ElseIf nContador == 27
			oSayLin27:nClrText := CLR_HRED
		ElseIf nContador == 28
			oSayLin28:nClrText := CLR_HRED
		ElseIf nContador == 29
			oSayLin29:nClrText := CLR_HRED
		ElseIf nContador == 30
			oSayLin30:nClrText := CLR_HRED
		ElseIf nContador == 31
			oSayLin31:nClrText := CLR_HRED
		ElseIf nContador == 32
			oSayLin32:nClrText := CLR_HRED
		ElseIf nContador == 33
			oSayLin33:nClrText := CLR_HRED
		ElseIf nContador == 34
			oSayLin34:nClrText := CLR_HRED
		ElseIf nContador == 35
			oSayLin35:nClrText := CLR_HRED
		ElseIf nContador == 36
			oSayLin36:nClrText := CLR_HRED
		ElseIf nContador == 37
			oSayLin37:nClrText := CLR_HRED
		ElseIf nContador == 38
			oSayLin38:nClrText := CLR_HRED
		ElseIf nContador == 39
			oSayLin39:nClrText := CLR_HRED
		ElseIf nContador == 40
			oSayLin40:nClrText := CLR_HRED
		ElseIf nContador == 41
			oSayLin41:nClrText := CLR_HRED
		ElseIf nContador == 42
			oSayLin42:nClrText := CLR_HRED
		ElseIf nContador == 43
			oSayLin43:nClrText := CLR_HRED
		ElseIf nContador == 44
			oSayLin44:nClrText := CLR_HRED
		ElseIf nContador == 45
			oSayLin45:nClrText := CLR_HRED
		ElseIf nContador == 46
			oSayLin46:nClrText := CLR_HRED
		ElseIf nContador == 47
			oSayLin47:nClrText := CLR_HRED
		ElseIf nContador == 48
			oSayLin48:nClrText := CLR_HRED
		ElseIf nContador == 49
			oSayLin49:nClrText := CLR_HRED
		ElseIf nContador == 50
			oSayLin50:nClrText := CLR_HRED
		ElseIf nContador == 51
			oSayLin51:nClrText := CLR_HRED
		ElseIf nContador == 52
			oSayLin52:nClrText := CLR_HRED
		ElseIf nContador == 53
			oSayLin53:nClrText := CLR_HRED
		ElseIf nContador == 54
			oSayLin54:nClrText := CLR_HRED
		ElseIf nContador == 55
			oSayLin55:nClrText := CLR_HRED
		ElseIf nContador == 56
			oSayLin56:nClrText := CLR_HRED
		ElseIf nContador == 57
			oSayLin57:nClrText := CLR_HRED
		ElseIf nContador == 58
			oSayLin58:nClrText := CLR_HRED
		ElseIf nContador == 59
			oSayLin59:nClrText := CLR_HRED
		ElseIf nContador == 60
			oSayLin60:nClrText := CLR_HRED
		ElseIf nContador == 61
			oSayLin61:nClrText := CLR_HRED
		ElseIf nContador == 62
			oSayLin62:nClrText := CLR_HRED
		ElseIf nContador == 63
			oSayLin63:nClrText := CLR_HRED
		ElseIf nContador == 64
			oSayLin64:nClrText := CLR_HRED
		ElseIf nContador == 65
			oSayLin65:nClrText := CLR_HRED
		ElseIf nContador == 66
			oSayLin66:nClrText := CLR_HRED
		ElseIf nContador == 67
			oSayLin67:nClrText := CLR_HRED
		EndIf
	EndIf
...
if lInacab
   DbSelectArea("SB2")
   DbSetOrder(1)
   if !SB2->( DbSeek(xFilial("SB2")+SC2->C2_PRODUTO+"02") )
      RecLock("SB2",.T.)
...
aMATRIZ := { { "D3_OP",      Left( cCODX, 11 ),               NIL },;
			 { "D3_COD",     SC2->C2_PRODUTO,                 NIL },;
  			 { "D3_LOCAL",   iif(lInacab,'02','01'),          NIL },; 			
			 { "D3_EMISSAO", Date(),                          NIL },;
