...
//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
////VOLTAR
//if ! Upper( Substr( cUsuario, 7, 5 ) ) $ "EMBALADORSC"
//   ALERT('Esta funcao so e valida para o embalador da fabrica de Saco' )
//	Return .F.
//endif
////VOLTAR
	...
	cNOMREL := setprint( cARQUIVO, cNOMREL, "ESTETQ4V", @cTITULO, cDESC1, cDESC2, cDESC3, .F. )
	...
	***************
		...
		If Abre_Impress()  //voltar
			...
			Do While nCONT <= ( MV_PAR02 )
				...
				///fim do bloco oficial voltar
				
				
				/////bloco teste - comentar qdo for oficial - pois é só pra teste
				/*
